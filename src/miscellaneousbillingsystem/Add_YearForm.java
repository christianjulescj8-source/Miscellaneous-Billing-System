...
public class Add_YearForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addyearbtn.setBorderPainted(false);
        addyearbtn.setFocusPainted(false);
        addyearbtn.setFocusable(false);
        ...
        undoyearbtn.setBorderPainted(false);
        undoyearbtn.setFocusPainted(false);
        undoyearbtn.setFocusable(false);
    ...
    private void addyearbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addyearbtnActionPerformed
        ...
        try {
            ...
            String newYear = "";
            if (rs.next()) {
                String lastYear = rs.getString("Year");
